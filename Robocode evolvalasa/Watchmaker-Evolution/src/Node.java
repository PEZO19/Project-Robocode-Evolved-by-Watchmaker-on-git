...
public interface Node
{
    ...
    //TODO: Miért nem generikusan csinálták meg ezt a részt? (ami nekünk QuestionBundle,de eddig double[] volt?)- hogyan lehetne? megcsináljuk?
    //TODO: A visszatérési értéket kellene talán igazán generikusan. VAgy Legalábbis itt azt lehetne továbbfejelszteni (I/H kibővítésére : A,B,C,D... esetekre)
    void evaluate(BeliefBase beliefBase);
     ...
     */
    Node mutate(Random rng, Probability mutationProbability, AbstractProgramCandidateFactory abstractProgramCandidateFactory);
